...
//
// The latest version of this file can be found at https://github.com/FlexValidator/FlexValidator

#endregion

#pragma warning disable 618

namespace FlexValidator.Resources;
...
internal class DutchLanguage {
	...
	public static string GetTranslation(string key) => key switch {
		...
		"LengthValidator" => "De lengte van '{PropertyName}' moet tussen {MinLength} en {MaxLength} karakters zijn. U heeft {TotalLength} karakters ingevoerd.",
		"MinimumLengthValidator" => "De lengte van '{PropertyName}' moet groter zijn dan of gelijk aan {MinLength} karakters. U heeft {TotalLength} karakters ingevoerd.",
		"MaximumLengthValidator" => "De lengte van '{PropertyName}' moet kleiner zijn dan of gelijk aan {MaxLength} karakters. U heeft {TotalLength} karakters ingevoerd.",
		...
		"ExactLengthValidator" => "De lengte van '{PropertyName}' moet {MaxLength} karakters zijn. U heeft {TotalLength} karakters ingevoerd.",
		...
		"MaximumLength_Simple" => "De lengte van '{PropertyName}' moet kleiner zijn dan of gelijk zijn aan {MaxLength} karakters.",
